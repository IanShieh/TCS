...
/// 更新單頭驗證器
/// </summary>
public class UpdateSampleHeaderValidator : AbstractValidator<UpdateSampleHeaderRequest>
{
    public UpdateSampleHeaderValidator()
    {
        RuleFor(x => x.TA003)
...
public class UpdateSampleDetailValidator : AbstractValidator<UpdateSampleDetailRequest>
{
    public UpdateSampleDetailValidator()
    {
        RuleFor(x => x.TB003)
